    ...
    return (
      <div>
        ...
        <div className={styles.featureContainer}> 
          <div className={styles.featureSquare} style={{backgroundImage: `url(${WaterImage})`}}>
          ...
          <div className={styles.featureSquare} style={{backgroundImage: `url(${EducationImage})`}}>
            <div className={styles.hoverContainer}>
              <div className={styles.featureSquareTitle}>
                EDUCATION
              </div>  
          ...
          <div className={styles.featureSquare} style={{backgroundImage: `url(${MedicalImage})`}}>
            <div className={styles.hoverContainer}>
              <div className={styles.featureSquareTitle}>
                MEDICAL
              </div>  
          ...
          <div className={styles.featureSquare} style={{backgroundImage: `url(${EmpowermentImage})`}}>
            <div className={styles.hoverContainer}>
              <div className={styles.featureSquareTitle}>
                EMPOWERMENT
              </div>  
